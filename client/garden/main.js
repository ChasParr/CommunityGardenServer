...
const renderGarden = function() {
    ...
    return (
      <div>
        <canvas id="canvas" height={500} width={700} onContextMenu={function(){return false;}} />
        <div id="userBox">
          <h3>Users:</h3>
          <ul id="userList" />
          <form id="userSettings">
            ...
            <input defaultValue="change" type="submit" />
          </form>
          <ul id="chatBox" />
          <form id="messageForm">
            <input id="messageField" name="messageField" autoComplete="off" type="text" />
            <input id="messageSubmit" defaultValue="send" type="submit" />
          </form>
        </div>
        <input id="karmaButton5" defaultValue="Buy 5 Karma" type="button" />
        <input id="karmaButton10" defaultValue="Buy 10 Karma" type="button" />
        <input id="karmaButton50" defaultValue="Buy 50 Karma" type="button" />
      </div>
    );
  };

const createGarden = function(csrf) {
    ...
    gardenRenderer = ReactDOM.render(
