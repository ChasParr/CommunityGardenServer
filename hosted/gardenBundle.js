...
var renderGarden = function renderGarden() {
    console.log('rendering');
    return React.createElement(
        'div',
        null,
        React.createElement('canvas', { id: 'canvas', height: 500, width: 700, onContextMenu: function onContextMenu() {
                return false;
            } }),
        React.createElement(
            'div',
            ...
            React.createElement(
                ...
                React.createElement('input', { id: 'nameField', name: 'name', type: 'text' }),
                React.createElement('input', { defaultValue: 'change', type: 'submit' })
            ),
            React.createElement('ul', { id: 'chatBox' }),
            React.createElement(
                'form',
                { id: 'messageForm' },
                React.createElement('input', { id: 'messageField', name: 'messageField', autoComplete: 'off', type: 'text' }),
                React.createElement('input', { id: 'messageSubmit', defaultValue: 'send', type: 'submit' })
            )
        ),
        React.createElement('input', { id: 'karmaButton5', defaultValue: 'Buy 5 Karma', type: 'button' }),
        React.createElement('input', { id: 'karmaButton10', defaultValue: 'Buy 10 Karma', type: 'button' }),
        React.createElement('input', { id: 'karmaButton50', defaultValue: 'Buy 50 Karma', type: 'button' })
    );
};

var createGarden = function createGarden(csrf) {
    ...
    var gardenContent = document.querySelector("#gardenContent");
    gardenRenderer = ReactDOM.render(React.createElement(Garden, null), gardenContent);
};
